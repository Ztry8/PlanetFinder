...
Читает и возвращает удобный для программы формат данных файлов обучения.
...
Скрипт загрузит кривые блеска из архива Kepler/TESS и сохранит их как `learn1.txt`, `learn2.txt`, ... в рабочую папку.
